...
export default function SearchPage() {
  ...
  const [searchCoords, setSearchCoords] = useState<{ lat: number; lng: number } | undefined>();

  const handleSearch = async (customFilters?: Partial<SearchFilters>, coords?: { lat: number; lng: number }) => {
    setLoading(true);
    setSearched(true);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-950">
      ...
      <main className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 mb-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-4">
            <div className="lg:col-span-2">
              ...
              <input
                type="text"
                placeholder="e.g., Palo Alto, Mountain View"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Results and/or Map */}
          <div className={showChat ? 'lg:col-span-8 xl:col-span-9' : 'lg:col-span-12'}>
              ...
              {(viewMode === 'split' || viewMode === 'list') && (
                <div className={viewMode === 'list' ? 'col-span-1' : ''}>
                  {loading ? (
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 max-h-[calc(100vh-8rem)] overflow-y-auto pr-2">
                    ...
                    <div className="text-center py-20">
                      <div className="text-gray-500 dark:text-gray-400 mb-4">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Try adjusting your filters or ask the AI assistant</p>
                      </div>
                    </div>
                  ) : null}
                </div>
