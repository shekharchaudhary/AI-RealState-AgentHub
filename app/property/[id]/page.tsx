          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                {property.yearBuilt && (
                  <div className="text-center">
                    ...
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{property.yearBuilt}</p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {property.hoaMonthly && (
                  <div className="flex justify-between py-2 border-b border-gray-200 dark:border-gray-700">
                    <span className="text-gray-600 dark:text-gray-400">HOA Monthly</span>
                    <span className="font-semibold text-gray-900 dark:text-white">
      ...
      <footer className="mt-16 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <p className="text-center text-gray-600 dark:text-gray-400">
            &copy; 2025 Nestora. Your AI Real Estate Assistant.
          </p>
        </div>
      </footer>
    </div>
