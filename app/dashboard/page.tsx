    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-950">
          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 rounded-full">
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300">{data?.user.name || 'Demo User'}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">Here&apos;s your activity overview</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl border border-gray-200 dark:border-gray-700 p-6 transition-all duration-300 hover:-translate-y-1">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
              {data?.stats.savedProperties ? 'properties you love' : 'No saved properties yet'}
            </p>
          </div>
          ...
          <div className="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl border border-gray-200 dark:border-gray-700 p-6 transition-all duration-300 hover:-translate-y-1">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
              {data?.stats.scheduledTours ? 'upcoming visits' : 'No tours scheduled'}
            </p>
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
              ...
              {data?.favorites && data.favorites.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                          {favorite.listing.beds} bd · {favorite.listing.baths} ba
                          {favorite.listing.sqft && ` · ${favorite.listing.sqft.toLocaleString()} sqft`}
                        </p>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">No saved properties yet</p>
                  <Link href="/search" className="text-blue-600 hover:text-blue-700 text-sm font-medium mt-2 inline-block">
                    Start searching →
                  </Link>
                </div>
              )}
            ...
            {/* Scheduled Tours */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Upcoming Tours</h2>
              {data?.tours && data.tours.length > 0 ? (
                      ...
                      >
                        <div className="flex-shrink-0">
                          <div className="w-16 h-16 bg-purple-100 dark:bg-purple-900/30 rounded-xl flex flex-col items-center justify-center">
                            ...
                            <p className="text-xs text-purple-600 dark:text-purple-400">
                              {tourDate.toLocaleDateString('en-US', { month: 'short' })}
                            </p>
                          </div>
                        </div>
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                            {tourDate.toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })}
                          </p>
                          <span
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">No tours scheduled</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="space-y-6">
            {/* Active Offers */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Active Offers</h2>
              {data?.offers && data.offers.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">No active offers</p>
                </div>
              )}
            </div>
