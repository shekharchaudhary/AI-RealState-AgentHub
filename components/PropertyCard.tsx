...
export default function PropertyCard({
  ...
  return (
    <Link href={`/property/${id}`}>
      <div className="group bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-md hover:shadow-2xl border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:-translate-y-1">
        <div className="relative h-56 bg-gray-200 dark:bg-gray-700 overflow-hidden">
          ...
          <div className="absolute top-3 right-3">
            <span className="px-3 py-1 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm text-sm font-semibold text-gray-900 dark:text-white rounded-full capitalize">
              {propertyType}
            </span>
          </div>
        </div>
